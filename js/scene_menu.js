class SceneMenu extends Phaser.Scene {
    ...
    create() {
        ...
        const title = this.add.text(GAME_WIDTH / 2, 140, 'CRYSTAL CAVERNS', {
        ...
        const startHint = this.add.text(GAME_WIDTH / 2, 460, 'or press SPACE / ENTER to begin', {
            fontFamily: 'Courier New',
            fontSize: '14px',
            color: '#5577aa'
        }).setOrigin(0.5);
        ...
        this.add.text(GAME_WIDTH / 2, 560, 'Made with Phaser 3  |  Hosted on GitHub Pages', {
            fontFamily: 'Courier New',
            fontSize: '12px',
            color: '#333355'
        }).setOrigin(0.5);
